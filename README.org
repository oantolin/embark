...
* How does Embark call the actions?
  ...
  Note that if a command does not prompt the user for input in the
  minibuffer, Embark still allows you to use it as an action, but of
  ...
  the user bound to keys in the action maps, most of the region
