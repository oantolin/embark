...
- The =embark-collect-live= variant of =embark-collect-snapshot= produces
  ...
  hide while using =embark-collect-live=. See the Embark wiki for
  [sample configuration for
  Selectrum](https://github.com/oantolin/embark/wiki/Additional-Configuration#pause-selectrum-while-using-embark-collect-live).
