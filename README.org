...
If you like this kind of prefix help, but want it to appear
automatically after a delay, like =which-key-mode= does by default, you
can use =embark-automatic-prefix-help-mode= (independently of whether
you also use the above setting for =prefix-help-command= or not).
